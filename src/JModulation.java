public class JModulation extends Effect{
    private JSynth synthesizer;
    private int defaultValue;
    public static int MODULATION = 1;

    public JModulation(JSynth synthesizer){
    ...
    public void setDefaultValue() {
        defaultValue = synthesizer.getChannel().getController(MODULATION);
    }
