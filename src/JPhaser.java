public class JPhaser extends Effect{
    private JSynth synthesizer;
    private int defaultValue;
    public static int PHASER = 95;

    public JPhaser(JSynth synthesizer){
    ...
    public void setDefaultValue() {
        defaultValue = synthesizer.getChannel().getController(PHASER);
    }
